...
class directedGraph {
	...
	/*
	 * The graph is stored in a hash table (called HashMap in Java). The
	 * vertices are identified by a String, which is used as key in the hash
	 * table. The information associated to each vertex v is a LinkedList of
	...
	// returns the page rank of a given vertex. If the vertex doesn't exist,
	// returns 0
